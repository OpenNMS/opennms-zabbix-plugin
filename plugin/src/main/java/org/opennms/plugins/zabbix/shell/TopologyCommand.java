...
import org.opennms.plugins.zabbix.TopologyForwarder;
import org.opennms.plugins.zabbix.model.Topology;

@Command(scope = "opennms-zabbix", name = "push-topology", description = "Push the topology")
@Service
